...
import liveApi from '../apis/Categories'
...
const app = () => {
    ...
    const myCustomShare = async () => {
        const shareOptions = {
            message: "Accede a la Television de la UATF por medio de este link http://laplumanegra.uatf.edu.bo/tvu",
        }
        try{
        ...
        <View>
            ...
            <View style={styles.cardRounded}>
                <View style={{ flexDirection: 'row', flexWrap: 'wrap'}}>
                    <Text style={styles.labell}>Television</Text>
