        ...
        <View>
            <View style={styles.cardRounded}>
                ...
                <WebView 
                    ...
                    style={{ height:140, width:320,alignSelf:"center",alignContent:"center", marginBottom: 20}}
                    // source={{uri: 'https://www.youtube.com/embed/gShA0l0T8S4'}}
                    source={{<iframe width="1838" height="773" src="https://www.youtube.com/embed/glhB1lsfcVs" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>}}
                />
            </View>
            <View style={styles.cardRounded}>
