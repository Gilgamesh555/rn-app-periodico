            ...
            <View style={styles.cardRounded}>
                ...
                <ScrollView>
                    <WebView 
                        ...
                        source={{html: <iframe width="1838" height="773" src="https://www.youtube.com/embed/glhB1lsfcVs" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen />}}
                    />
                </ScrollView>
            </View>
            <View style={styles.cardRounded}>
