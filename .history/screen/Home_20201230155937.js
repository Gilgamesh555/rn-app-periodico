...
export default function Screen({route,navigation}) {
    return (
      <AnimatedHeader 
        ...
        title='UATF'
        renderRight={() => (
            <View {{justifyContent: 'center', alignItems: 'center', flexDirection: 'row', flexWrap: 'wrap', paddingBottom: 25, paddingTop: 20}}>
            <Button transparent
        ...
        <ScrollView>
            ...
            <View style={{justifyContent: 'center', alignItems: 'center', flexDirection: 'row', flexWrap: 'wrap', paddingBottom: 25, paddingTop: 20}}>
                ...
                <View style={{justifyContent: 'center', alignItems: 'center', paddingRight: 16}}>
                    ...
                    />
                    <Text style={{alignContent: 'center'}}>Contactos</Text>
                </View>      
            </View>
            <View style={{justifyContent: 'center', alignItems: 'center', flexDirection: 'row', flexWrap: 'wrap', paddingBottom: 25, paddingTop: 20}}>
                <View style={{justifyContent: 'center', alignItems: 'center', paddingRight: 16}}>
                ...
                <View style={{justifyContent: 'center', alignItems: 'center', paddingRight: 16}}>
                    ...
                    />
                    <Text style={{alignContent: 'center'}}>Anuncios</Text>
                </View>      
            </View>
            <View style={{justifyContent: 'center', alignItems: 'center', flexDirection: 'row', flexWrap: 'wrap', paddingBottom: 25, paddingTop: 20}}>
                <View style={{justifyContent: 'center', alignItems: 'center', paddingRight: 16}}>
