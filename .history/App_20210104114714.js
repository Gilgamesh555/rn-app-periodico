...
//Test
import NotifScreen from './screen/ClasifScreen'
...
function HomeStack({route, navigation}) {
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen name="HomeC" component={CommuniqueScreen} options={{headerShown: false}}/>
      <Stack.Screen name="ComunicadoD" component={CommuniqueDetails} />
      <Stack.Screen name="Monedas" component={CurrencyScreen}/>
      {/* <Stack.Screen name="Monedas" component={NotifScreen}/> */}
    </Stack.Navigator>
  );
}
...
function CommuniqueStack({route, navigation}) {
  return (
    <Stack.Navigator>
      <Stack.Screen name="Home" component={CurrencyScreen} options={{headerShown: false}}/>
      {/* <Stack.Screen name="ComunicadoD" component={CommuniqueDetails} /> */}
    </Stack.Navigator>
  );
}
